...
void set_alpha_blender(void) {
	...
	if ((_G(_rgb_g_shift_32) == 8) && (_G(_rgb_a_shift_32) == 24)) {
		r = (_G(_rgb_r_shift_32)) ? 1 : 0;
		b = (_G(_rgb_b_shift_32)) ? 1 : 0;
	} else
		r = b = 0;
	...
	if ((_G(_rgb_r_shift_15) == r * 10) && (_G(_rgb_g_shift_15) == 5) && (_G(_rgb_b_shift_15) == b * 10))
		f15 = _blender_alpha15_rgb;
	else if ((_G(_rgb_r_shift_15) == b * 10) && (_G(_rgb_g_shift_15) == 5) && (_G(_rgb_b_shift_15) == r * 10))
		f15 = _blender_alpha15_bgr;
	else
		f15 = _blender_alpha15;

	/* decide which 16 bit blender to use */
	if ((_G(_rgb_r_shift_16) == r * 11) && (_G(_rgb_g_shift_16) == 5) && (_G(_rgb_b_shift_16) == b * 11))
		f16 = _blender_alpha16_rgb;
	else if ((_G(_rgb_r_shift_16) == b * 11) && (_G(_rgb_g_shift_16) == 5) && (_G(_rgb_b_shift_16) == r * 11))
	...
	if ((_G(_rgb_r_shift_24) == r * 16) && (_G(_rgb_g_shift_24) == 8) && (_G(_rgb_b_shift_24) == b * 16))
		f24 = _blender_alpha32;
	else if ((_G(_rgb_r_shift_24) == b * 16) && (_G(_rgb_g_shift_24) == 8) && (_G(_rgb_b_shift_24) == r * 16))
...
#endif
#else
	error("TODO: set_blender_mode_ex(_blender_black, _blender_black, _blender_black, f32, f15, f16, f24, 0, 0, 0, 0);");
#endif
}
