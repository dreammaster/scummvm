...
//
//=============================================================================
#ifndef AGS_ENGINE_AC__SCREENOVERLAY_H
#define AGS_ENGINE_AC__SCREENOVERLAY_H

//include <stdint.h>

// Forward declaration
namespace AGS { namespace Shared { class Bitmap; class Stream; } }
...
#endif // AGS_ENGINE_AC__SCREENOVERLAY_H
