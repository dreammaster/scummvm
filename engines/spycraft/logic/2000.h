...
{
 public:
 	TravelInScript2001() { name = "TravelInScript2001"; };
...
{
 public:
 	EnterScript2000() { name = "EnterScript2000"; };
	void changeState( int );
};
...
{
 public:
 	LEDBlinkScript2100() { name = "LEDBlinkScript2100"; };
	void changeState( int );
};	  
...
{
 public:
 	BigButtonPressScript2100() { name = "BigButtonPressScript2100"; };
...
{
 public:
 	Button1PressScript2100() { name = "Button1PressScript2100"; };
...
{
 public:
 	PhoneMessagesScript2100() { name = "PhoneMessagesScript2100"; };
	void changeState( int );
};
...
{
 public:
 	PhoneWomanScript2100() { name = "PhoneWomanScript2100"; };
	void changeState( int );
};
...
{
 public:
 	AdamsPhoneScript2100() { name = "AdamsPhoneScript2100"; };
	void changeState( int );
};
...
{
 public:
 	FrankSadScript2000() { name = "FrankSadScript2000"; };
	void changeState( int );
};
...
{
 public:
 	FrankComingScript2200() { name = "FrankComingScript2200"; };
 	void changeState( int );
};
...
{
 public:
 	ColbyPictScript2200() { name = "ColbyPictScript2200"; };
 	void changeState( int );
};
...
{
 public:
 	HarmonicaPictScript2200() { name = "HarmonicaPictScript2200"; };
 	void changeState( int );
};
...
{
 public:
 	FrankIntroScript2200() { name = "FrankIntroScript2200"; };
 	void changeState( int );
};
