...
{
 public:
 	ZipScript24100() { name = "ZipScript24100"; };
...
{
 public:
 	FolderSndScript24100() { name = "FolderSndScript24100"; };
	void changeState( int );
};
...
{
 public:
 	JaimieBlamScript24000() { name = "JaimieBlamScript24000"; };
	void changeState( int );
};
...
{
 public:
 	EBMCatScript24100() { name = "EBMCatScript24100"; };
	void changeState( int );							
};
...
{
 public:
 	YingBealeScript24100() { name = "YingBealeScript24100"; };
	void changeState( int );							
};
...
{
 public:
 	launchShanghai() { name = "launchShanghai"; };
	void changeState( int );							
};
