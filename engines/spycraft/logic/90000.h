...
{
 public:	   
 	HeliBlowupScript()	{ name = "HeliBlowupScript";}; 
...
class HeliTransferScript : public Script
{
 public:
 	Sound *pilotVo2;
 	HeliTransferScript() { name = "HeliTransferScript"; pilotVo2 = new Sound; }; 
	void changeState( int );
};
...
class HeliTimerStart : public Script
{
 public:
 	Sound *pilotVo1;
 	HeliTimerStart() { name = "HeliTimerStart"; pilotVo1 = new Sound; }; 
	void changeState( int );
};
...
class ExplodeSound : public Script
{
 public:
 	Sound *explode;
	Sound *pilotVo3;
 	ExplodeSound() { name = "ExplodeSound"; explode = new Sound; pilotVo3 = new Sound; }; 
	void changeState( int );
};
...
{
 public:
 	StatusBarStart() { name = "StatusBarStart"; }; 
	void changeState( int );
};
...
class OkButtonClick : public Script
{
 public:
 	Sound *oksound;
 	OkButtonClick() { name = "OkButtonClick"; oksound = new Sound; }; 
	void changeState( int );
};
...
{
 public:
 	CancelButtonClick() { name = "CancelButtonScript"; }; 
	void changeState( int );
};
...
class StopButtonClick : public Script
{
 public:
 	Sound *snd5;
 	StopButtonClick() { name = "StopButtonClick"; snd5 = new Sound; }; 
	void changeState( int );
};
...
class BackpackSound : public Script
{
 public:
 	Sound *snd6;
 	BackpackSound() { name = "BackpackSound"; snd6 = new Sound; }; 
	void changeState( int );
};
