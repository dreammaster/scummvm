...
#ifndef GLK_ZCODE_COMMON_FROTZ_H
#define GLK_ZCODE_COMMON_FROTZ_H

#include "glk/zcode/common/defs.h"
#include "glk/zcode/common/setup.h"
#include "glk/zcode/common/missing.h"
#include "glk/zcode/glk/io.h"

namespace Glk {
namespace ZCode {

extern int frotz_main(int argc, const char *argv[]);
...
void 	os_process_arguments(int, const char *[]);
