...
static int myheight(SFONT *s) {
	return 8;
}
static int myascent(SFONT *s) {
	return 6;
}
static int mydescent(SFONT *s) {
	return 2;
}
static int myminchar(SFONT *s) {
	return 32;
}
static int mymaxchar(SFONT *s) {
	return 126;
}
...
static int myheight2(SFONT *s) {
	return 16;
}
static int myascent2(SFONT *s) {
	return 14;
}
static int mydescent2(SFONT *s) {
	return 2;
}
