...
#ifndef TADS3_VMPARAM_H
#define TADS3_VMPARAM_H

/* T3 Virtual Machine Initialization Parameters
 *
 * Defines a set of parameters that we use to initialize the VM during program startup.
 * These parameters are #define'd here if not already #define'd elsewhere - this allows
 * the system makefile to override the parameters as desired for larger or smaller
 * local limits.  For example, with a conventional Unix makefile, one could override the
 ...
 *   porting.
 */
#ifndef TADS3_VM_ERR_STACK_SIZE
 ...
 */
#ifndef TADS3_VM_ERR_MSG_FNAME
# define VM_ERR_MSG_FNAME "T3_VM.msg"
#endif
#ifndef TADS3_VM_ERR_MSG_RESTYPE
 ...
 */
#ifndef TADS3_VM_STACK_DBG_RESERVE
 ...
 */
#ifndef TADS3_VM_UNDO_MAX_RECORDS
# define VM_UNDO_MAX_RECORDS  4096
#endif
#ifndef TADS3_VM_UNDO_MAX_SAVEPTS
