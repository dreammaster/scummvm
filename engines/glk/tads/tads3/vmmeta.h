...
#ifndef TADS3_VMMETA_H
#define TADS3_VMMETA_H

/* Metaclass dependency table
 * The metaclass dependency table establishes the correspondence between metaclass
 * index numbers and metaclasses.  The load image file contains a list of the metaclasses
 * that the program requires, identifying each required metaclass with its universally
 * unique identifier string.  At load time, we scan this list in the load image and create
 * a dependency table.
*/
