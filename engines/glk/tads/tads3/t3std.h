...
#ifndef TADS3_T3_STD_INCLUDED
#define TADS3_T3_STD_INCLUDED
 ...
 */
void os_init_ui_after_load(CVmBifTable *bif_table, CVmMetaTable *meta_table);
...
#ifndef TADS3_OS_UCHAR_DEFINED
typedef unsigned char  uchar;
#endif

#ifndef TADS3_OS_USHORT_DEFINED
typedef unsigned short ushort;
#endif

#ifndef TADS3_OS_UINT_DEFINED
typedef unsigned int   uint;
#endif

#ifndef TADS3_OS_ULONG_DEFINED
typedef unsigned long  ulong;
#endif

/* sizeof() extension macros */
#ifndef TADS3_countof
...
inline int is_syminit(wchar_t c)
{
    ...
    return (is_ascii(c) && (c == '_' || Common::isAlpha((char)c)));
}
...
inline int is_sym(wchar_t c)
{
    ...
    return (is_ascii(c) && (c == '_' || Common::isAlpha((char)c) || Common::isDigit((char)c)));
}

/* determine if a character is ASCII lower-case */
inline int is_lower(wchar_t c) { return (is_ascii(c) && Common::isLower((char)c)); }
