...
#ifndef TADS3_TCPRSTYP_H
#define TADS3_TCPRSTYP_H

/* TADS 3 compiler - parser type definitions
 *
 * Defines some types for the TADS 3 compiler's parser.  Separated from the main parser
 * include file to reduce the amount of the parser that has to be included simply for
