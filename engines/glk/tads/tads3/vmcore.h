...
#ifndef TADS3_VMCORE_H
#define TADS3_VMCORE_H

/* T3 VM "core" interpreter - example function set definition
 *
 ...
 * changes:
 *
 * 1. Change the #ifndef TADS3_symbol from VMCORE_H to a different name of your
