...
#ifndef TADS3_VMANONFN_H
#define TADS3_VMANONFN_H

/* Anonymous function metaclass
 *
 * The anonymous function metaclass is a subclass of the Vector metaclass that provides
 * encapsulation of an anonymous function and the context it shares with its enclosing scope.
 */
