 ...
 *
 * All expression parse nodes are derived from the target-specific subclass of this class.
 * The target-independent base class is CTcPrsNodeBase; the target-specific class is CTcPrsNode.
*/
