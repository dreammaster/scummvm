...
/* Tads 3 compiler - javascript code generator - intermediate parse node classes */

#ifndef TADS3_TCJSINT_H
#define TADS3_TCJSINT_H

#include "glk/tads/tads3/tcjsbase.h"
#include "glk/tads/tads3/tcpnint.h"
