...
#ifndef TADS3_VMDYNFUNC_H
#define TADS3_VMDYNFUNC_H

/* Code Object
 *
 * A Code Object is an intrinsic class object that contains a block of byte code.
 * This can be used for things like debugger expressions and run-time evaluation
 * and code creation.
 *
 * A Code Object is immutable, like a String or List.  It contains the original
 * source code text, as a UTF-8 string, and the corresponding compiled byte code.
*/
