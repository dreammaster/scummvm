...
#ifndef TADS3_OSIFCNET_H
#define TADS3_OSIFCNET_H

/* TADS operating system interfaces for networking and threading
 *
...
/* ------------------------------------------------------------------------ */
/*
 *   IMPORTANT: in your OS-specific header, #include "glk/tads/tads3/vmrefcnt.h" here,
...
#elif defined(_WIN32)
#include "glk/tads/tads3/osnetwin.h"

#elif defined(UNIX) || defined(FROBTADS)
#include "glk/tads/tads3/osnetunix.h"
