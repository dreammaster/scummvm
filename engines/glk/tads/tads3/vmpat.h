...
#ifndef TADS3_VMPAT_H
#define TADS3_VMPAT_H

/* Regular-expression compiled pattern object
 *
 * Encapsulates a compiled regular expression as an object.  This object allows a compiled
 * regular expression to be saved for re-use; since regex compilation is time-consuming,
 * it's much more efficient to re-use a compiled pattern in repeated searches than to
 * recompile the expression each time it's needed.
 */
