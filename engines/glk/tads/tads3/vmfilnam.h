...
#ifndef TADS3_VMFILNAM_H
#define TADS3_VMFILNAM_H

/* CVmObjFileName object
 *
 * A FileName represents a local filename string.  This is essentially just a string
 * containing the filename, but provides methods to manipulate the name portably,
 * using the various osifc path manipulation routines.
*/
