...
#ifndef TADS3_VMREGEX_H
#define TADS3_VMREGEX_H

/* Regular expression parser for T3
 *
 * Adapted from the TADS 2 regular expression parser.  This version uses UTF-8 strings rather than
 * simple single-byte character strings, and is organized into a C++ class.
 */
