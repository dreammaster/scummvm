...
#ifndef TADS3_VMFINDREP_H
#define TADS3_VMFINDREP_H

/* Find/replace common code template
 *
 ...
 * and test the conditions statically.  This makes for larger but faster code.
*/
