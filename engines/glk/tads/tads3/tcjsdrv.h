...
#ifndef TADS3_TCJSDRV_H
#define TADS3_TCJSDRV_H

/* Tads 3 compiler - javascript code generator - parse node classes */

#include "glk/tads/tads3/tcjsint.h"
#include "glk/tads/tads3/tcpndrv.h"
