...
#ifndef TADS3_VMVEC_H
#define TADS3_VMVEC_H

/* T3 VM Vector class
 *
 * A Vector is a subclass of Collection.  A Vector is a List whose elements can be changed
 * in-place, and whose size can change.
 */
