...
/* Tads 3 compiler - javascript code generator - parse node base class definitions */

#ifndef TADS3_TCJSBASE_H
#define TADS3_TCJSBASE_H

#include "glk/tads/tads3/tcprs.h"
#include "glk/tads/tads3/tcpnbase.h"
