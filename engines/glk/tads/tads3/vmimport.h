 ...
 *
 * Note that this file is NOT protected against multiple inclusion, because it is included
 * in several different ways to generate different tables.
 *
 * Each includer must define the generator macros (VM_IMPORT, VM_IMP_xxx, etc) just before
 * including this file.  The macros are to be defined as needed by the includer to generate
