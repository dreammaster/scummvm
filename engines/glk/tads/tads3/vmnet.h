...
#ifndef TADS3_VMNET_H
#define TADS3_VMNET_H

/* TADS 3 networking
 *
 * Defines the networking layer for TADS 3.  This is used for the web server configurations.
 * This is portable code implementing high-level network operations, such as an HTTP server,
 * using the low-level socket and thread API defined in osifcnet.h.
*/
...
#include "glk/tads/tads3/vmdbg.h"
#include "glk/tads/tads3/vmglob.h"
#include "glk/tads/tads3/vmstrref.h"
