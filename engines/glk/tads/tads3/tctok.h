...
#ifndef TADS3_TCTOK_H
#define TADS3_TCTOK_H

/* TADS3 compiler tokenizer and preprocessor
 *
 * The tokenizer is layered with the preprocessor, so that the preprocessor can deal
 * with include files, macro expansion, and preprocessor directives.
 */
...
#include "glk/tads/tads3/tcerrnum.h"
...
private:
    ...
    /* process a #ifdef or #ifndef TADS3_*/
