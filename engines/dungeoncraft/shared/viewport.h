...
#ifndef DUNGEONCRAFT_SHARED_VIEWPORT
#define DUNGEONCRAFT_SHARED_VIEWPORT
...
void drawBorder();
void drawViewport(BOOL drawMiddleVertBar=TRUE, BOOL drawFrame=TRUE);
void drawViewportFrame(int x, int y);
void DetermineView(int facing,int x, int y);
void updateViewport(int plyrX, int plyrY, int facing, long int dstSurface=BACKBUFFERNUM);
