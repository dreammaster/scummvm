...
#ifndef DUNGEONCRAFT_SHARED_CONFIG_FILE
#define DUNGEONCRAFT_SHARED_CONFIG_FILE
...
private:
  ...
  public:
    ...
    int NumberOfObjects(void) {return m_numberOfObjects;};
