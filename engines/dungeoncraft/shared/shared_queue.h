...
#ifndef DUNGEONCRAFT_SHARED_SHARED_QUEUE
#define DUNGEONCRAFT_SHARED_SHARED_QUEUE
...
private:
   ...
   CList<T, T&> m_Msgs; // templatized linked list of nodes
};
...
private:
   ...
   CList<OrderedQueueNode<T>, OrderedQueueNode<T>&> m_Msgs; 
...
OrderedQueue< T, Size > &OrderedQueue< T, Size >::operator =(const OrderedQueue< T, Size >& src)
{
  ...
  while (p != NULL)
  {
    OrderedQueueNode<T> temp = src.m_Msgs.GetNext(p);
...
//*****************************************************************************
template <class T, long Size> 
T& OrderedQueue< T, Size >::GetAt(DWORD key)
{
...
//*****************************************************************************
template <class T, long Size> 
POSITION OrderedQueue< T, Size >::FindKeyPos(DWORD key)
{
...
private:
   ...
   // templatized container of nodes
   CList<UnorderedQueueNode<T>, UnorderedQueueNode<T>&> m_Msgs; 
