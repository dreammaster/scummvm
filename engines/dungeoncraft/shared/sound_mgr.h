...
#ifndef DUNGEONCRAFT_SHARED_SOUNDMGR
#define DUNGEONCRAFT_SHARED_SOUNDMGR
...
#include "dungeoncraft/shared/CDXSound.h"
//#include "dungeoncraft/shared/CDXMusic.h"
...
public:
  ...
  BOOL operator ==(BACKGROUND_SOUNDS& src);
...
public:
  ...
  BOOL operator ==(BACKGROUND_SOUND_DATA& src);
...
void saveSound(CString &filename, int level, BOOL alterPath=TRUE);
