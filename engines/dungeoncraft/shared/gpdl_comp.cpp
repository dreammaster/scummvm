...
public:                                                       //INPUTFILE
  ...
  int Initialize(                                             //INPUTFILE
        ...
        int ProcessErrorMessage(const CString &errMsg));      //INPUTFILE
...
void INPUTFILE::m_pop(void) {                                 //INPUTFILE
  ...
  if (m_line!=NULL) free ((char *)m_line);                    //INPUTFILE
...
//  char *newfilename, *pChar;                                //INPUTFILE
  ...
  while (1) {                                                 //INPUTFILE
    if (m_line[m_lineIndex]==0) {                             //INPUTFILE
      if (m_file != NULL)                                     //INPUTFILE
      {                                                       //INPUTFILE
        result=m_file->Read((char *)m_line,m_MAXLINELEN);     //INPUTFILE
...
{                                                             //INPUTFILE
  ...
  {                                                           //INPUTFILE
    TRACE(".");                                               //INPUTFILE
    (*m_ProcessErrorMessage)(".");                            //INPUTFILE
    return;                                                   //INPUTFILE
  };                                                          //INPUTFILE
  TRACE("%s\n",text);                                         //INPUTFILE
  ...
  (*m_ProcessErrorMessage)(message);                          //INPUTFILE
  ...
  {                                                           //INPUTFILE
    ...
    {                                                         //INPUTFILE
      ...
      (*m_ProcessErrorMessage)(" Error in ");                 //INPUTFILE
    }                                                         //INPUTFILE
    else                                                      //INPUTFILE
    {                                                         //INPUTFILE
      TRACE("  Called from ");                                //INPUTFILE
      (*m_ProcessErrorMessage)("  Called from ");             //INPUTFILE
    };                                                        //INPUTFILE                 
    if (m_file != NULL)                                       //INPUTFILE
    {                                                         //INPUTFILE
    ...
    {                                                         //INPUTFILE
      ...
      (*m_ProcessErrorMessage)("main program");               //INPUTFILE
    };                                                        //INPUTFILE
...
struct SYSTEMFUNCTION {                                       //code
  ...
  BYTE   UsageType;                                           //code
  unsigned char types[4];                                     //code
};                                                            //code
                                                              //code
void CODE::Initialize(void)                                   //code
{                                                             //code
  if (m_code != NULL) free(m_code);                           //code
  m_H=0;                                                      //code
  m_allocated=0;                                              //code
  m_code=NULL;                                                //code
}                                                             //code
...
void CODE::comma(unsigned int binCode) {                      //code
  ...
  {                                                           //code
    ...
    m_code=(unsigned int *)realloc(m_code,m_allocated*sizeof (int));
    if (m_code==NULL)                                         //code
    {                                                         //code
...
private:                                                      //DICTIONARY
  ...
  unsigned char m_types[4];    //If system function then this //DICTIONARY
                               // is return type and 3 parameter types.
public:                                                       //DICTIONARY
...
class CONSTANT {                                              //DICTIONARY
  friend class CONSTANTS;                                     //DICTIONARY
private:                                                      //DICTIONARY
  char      m_id[4];    // "CON"                              //DICTIONARY
  CString     m_value;                                        //DICTIONARY
  unsigned int  m_index;  // The address by which I am referenced in the code.
public:                                                       //DICTIONARY
  CONSTANT (void);                                            //DICTIONARY
  ~CONSTANT (void);                                           //DICTIONARY
...
private:                                                      //DICTIONARY
  char     m_id[4];      // "con"                             //DICTIONARY
  CONSTANT    *m_values;                                      //DICTIONARY
  unsigned int m_allocatedSize;                               //DICTIONARY
  unsigned int m_used;                                        //DICTIONARY
public:                                                       //DICTIONARY
  CONSTANTS (void);                                           //DICTIONARY
  ~CONSTANTS (void);                                          //DICTIONARY
  CONSTANT *search(CString& value);                           //DICTIONARY
  CONSTANT *insert(CString& value); // Uses existing entry if possible
...
DEFINITION::DEFINITION (void) {                               //DICTIONARY
  ...
  for (i=0; i<4; i++) m_types[i] = 0;                         //DICTIONARY
}                                                             //DICTIONARY
                                                              //DICTIONARY
DEFINITION::~DEFINITION(void) {                               //DICTIONARY
...
//      if (dict->m_FLG_function) local=false;                //DICTIONARY
    ...
    return dict->localLookup(name);                           //DICTIONARY
                                                              ...
                                                              //DICTIONARY
CONSTANTS::CONSTANTS(void) {                                  //DICTIONARY
  ...
  m_values=new CONSTANT[m_allocatedSize];                     //DICTIONARY
  for (i=1; i<m_allocatedSize; i++) m_values[i].m_index=i;    //DICTIONARY
...
CONSTANTS::~CONSTANTS(void) {                                 //DICTIONARY
  ...
  m_used=0;                                                   //DICTIONARY
                                                              ...
                                                              //DICTIONARY
CONSTANT::CONSTANT (void)                                     //DICTIONARY
{                                                             //DICTIONARY
  m_index=0xffffffff;                                         //DICTIONARY
  strcpy(m_id,"CON");                                         //DICTIONARY
}                                                             //DICTIONARY
                                                              //DICTIONARY
CONSTANT::~CONSTANT (void) {                                  //DICTIONARY
                                                              ...
                                                              //DICTIONARY
void CONSTANT::addCodeReference(void) {                       //DICTIONARY
  code.comma((BINOP_FETCHCONSTANT<<24)|m_index);              //DICTIONARY
}                                                             //DICTIONARY
                                                              //DICTIONARY
CONSTANT *CONSTANTS::insert(CString& value) {                 //DICTIONARY
  CONSTANT *result;                                           //DICTIONARY
  result=search(value);                                       //DICTIONARY
  if (result!=NULL) return result;                            //DICTIONARY
  if (m_used >= m_allocatedSize)                              //DICTIONARY
  {                                                           //DICTIONARY
    // We need to expand the CONSTANT array.                  //DICTIONARY
    unsigned int newsize;                                     //DICTIONARY
    unsigned int i;                                           //DICTIONARY
    newsize=(m_allocatedSize*5)/4;                            //DICTIONARY
    result=new CONSTANT[newsize];                             //DICTIONARY
    for (i=0; i<newsize; i++) {                               //DICTIONARY
      if (i<m_allocatedSize) result[i]=m_values[i];           //DICTIONARY
      else result[i].m_index=i;                               //DICTIONARY
    };                                                        //DICTIONARY
    delete []m_values;                                        //DICTIONARY
  ...
  return result;                                              //DICTIONARY
                                                              ...
                                                              //DICTIONARY
CONSTANT *CONSTANTS::search(CString& value) {                 //DICTIONARY
  CONSTANT *result;                                           //DICTIONARY
  for (result=m_values+1;                                     //DICTIONARY
       result!=m_values+m_used;                               //DICTIONARY
       result=result++) {                                     //DICTIONARY
    if (result->m_value==value) return result;                //DICTIONARY
  };                                                          //DICTIONARY
  return NULL;                                                //DICTIONARY
}                                                             //DICTIONARY
                                                              //DICTIONARY
CString CONSTANTS::getValue(unsigned int index) {             //DICTIONARY
  if (index<m_used) return m_values[index].m_value;           //DICTIONARY
  return CString("Undefined");                                //DICTIONARY
}                                                             //DICTIONARY
                                                              //DICTIONARY
int CONSTANTS::write(CArchive& ar) {                          //DICTIONARY
  unsigned int i;                                             //DICTIONARY
...
void GPDLCOMP::compileFalse(void) {                           //Little
  ...
  //constants.insert(False)->addCodeReference();              //Little
...
SYSTEMFUNCTION systemfunctions[] = 
{
  ...
  {"$GET_CHAR_THACO"           ,1,SUBOP_GET_CHAR_THACO          ,ALL_USAGE,0,0},
  {"$SET_CHAR_THACO"           ,2,SUBOP_SET_CHAR_THACO          ,ALL_USAGE,0,0,0},
  ...
  {"$GET_CHAR_STR"             ,1,SUBOP_GET_CHAR_STR            ,ALL_USAGE,0,0},
  {"$SET_CHAR_STR"             ,2,SUBOP_SET_CHAR_STR            ,ALL_USAGE,0,0,0},
  {"$GET_CHAR_STRMOD"          ,1,SUBOP_GET_CHAR_STRMOD         ,ALL_USAGE,0,0},
  {"$SET_CHAR_STRMOD"          ,2,SUBOP_SET_CHAR_STRMOD         ,ALL_USAGE,0,0,0},
  {"$GET_CHAR_INT"             ,1,SUBOP_GET_CHAR_INT            ,ALL_USAGE,0,0},
  {"$SET_CHAR_INT"             ,2,SUBOP_SET_CHAR_INT            ,ALL_USAGE,0,0,0},
  {"$GET_CHAR_WIS"             ,1,SUBOP_GET_CHAR_WIS            ,ALL_USAGE,0,0},
  {"$SET_CHAR_WIS"             ,2,SUBOP_SET_CHAR_WIS            ,ALL_USAGE,0,0,0},
  {"$GET_CHAR_DEX"             ,1,SUBOP_GET_CHAR_DEX            ,ALL_USAGE,0,0},
  {"$SET_CHAR_DEX"             ,2,SUBOP_SET_CHAR_DEX            ,ALL_USAGE,0,0,0},
  {"$GET_CHAR_CON"             ,1,SUBOP_GET_CHAR_CON            ,ALL_USAGE,0,0},
  {"$SET_CHAR_CON"             ,2,SUBOP_SET_CHAR_CON            ,ALL_USAGE,0,0,0},
  {"$GET_CHAR_CHA"             ,1,SUBOP_GET_CHAR_CHA            ,ALL_USAGE,0,0},
  {"$SET_CHAR_CHA"             ,2,SUBOP_SET_CHAR_CHA            ,ALL_USAGE,0,0,0},
  ...
  {"$GET_CHAR_MAGUSERLVL"      ,1,SUBOP_GET_CHAR_MAGUSERLVL     ,ALL_USAGE,0,0},
  {"$GET_CHAR_CLERICPREVLVL"   ,1,SUBOP_GET_CHAR_CLERICPREVLVL  ,ALL_USAGE,0,0},
  ...
  {"$Class"                    ,1,SUBOP_Class                   ,ALL_USAGE,0,ACTOR}, // ClassType Class(Actor)
  {"$Race"                     ,1,SUBOP_Race                    ,ALL_USAGE,0,ACTOR}, // RaceType Race(Actor)
  {"$Target"                   ,0,SUBOP_Target                  ,ALL_USAGE,ACTOR},   // Actor Target()
  ...
  {"$GET_HASDWARFTHACOPENALTY"  ,1,SUBOP_GET_HASDWARFTHACOPENALTY ,ALL_USAGE,STRING,ACTOR},
  {"$GET_HASGNOMETHACOPENALTY"  ,1,SUBOP_GET_HASGNOMETHACOPENALTY ,ALL_USAGE,STRING,ACTOR},
  ...
  {"$InvokeSpellOnTarget"       ,2,SUBOP_INVOKESPELLONTARGET      ,ALL_USAGE,STRING,ACTOR,STRING},
  {"$InvokeSpellOnTargetAs"     ,3,SUBOP_INVOKESPELLONTARGETAS    ,ALL_USAGE,STRING,ACTOR,STRING,ACTOR},
...
int GPDLCOMP::compileAtomicElement(void) {
  ...
  if (tokenType == TKN_OPENPAREN)
  {
    ...
    constants.insert(token)->addCodeReference();
  }
    ...
    else if (def->FLG_function()) 
    {
      ...
      if (result) 
      {
        infile.error("Called from compileAtomicElement",false);
        return result;
      };
    }
    else
...
int GPDLCOMP::compileExpression(void)
{
  ...
  //    stack and go to 1)
  // 3) Perform the opeation on the top of the stack.  Go to 2)
  //
...
int GPDLCOMP::compileWhile(void) 
{
  ...
  result=compileExpression();
  if (result) {
    infile.error("Called form compileWhile",false);
    return 1;
  };
...
int GPDLCOMP::compileFunctionDecl(unsigned int attributes) 
{
  ...
  newFunc->setIntValue(code.here());
  {
    ...
    constants.insert(entryDebug)->addCodeReference();
...
static int ProcessScriptError(const CString& msg)
{
  scriptError += msg;
  scriptError += '\n';
  return 0;
...
CString GPDLCOMP::CompileScript(const CString& script, const char *entryPoints[])
{
  ...
  int numEntry;
  int numConstant, numNeededConstant;
  int totalSizeOfConstants;
  int binaryCodeSize;
  int pConstant;
  int entryAddress;
  int codeLen;
  int xlate, opcode;
  char *binaryCode;
  CString constant, entryName, emptyString;
  emptyString = "";
  scriptError = "";
  ...
  binaryCodeSize = 
       ...
       + totalSizeOfConstants // The data itself
       ;
  binaryCode = (char *)alloca(binaryCodeSize);
  headerOffset = 4*numConstant;
  ...
  *(int *)(binaryCode+headerOffset+1) = numEntry;
  ...
  for (i=0; i<numConstant; i++)
  {
    ...
    if (j == sizeof (builtinLit)/sizeof (BUILTINLIT))
    {
      strcpy(binaryCode + codeOffset + pConstant, LPCTSTR(constant));
      ((int *)(binaryCode))[i] = pConstant;
      pConstant += constant.GetLength() + 1;
    }
    else
    {
      ((int *)(binaryCode))[i] 
  ...
  *(int *)(binaryCode + headerOffset + 8) = totalSizeOfConstants;
  codeLen = code.here();
  *(int *)(binaryCode + headerOffset + 4) = codeLen;
  ...
  {
    opcode = code.peek(i);
    if (((opcode>>24) & 0xff) == BINOP_FETCHCONSTANT)
    {
  ...
  return CString(binaryCode+headerOffset,
                 12 + 4*(codeLen+numEntry) + totalSizeOfConstants);
}
...
{
  return constants.getValue(n);
}

unsigned int GPDLCOMP::constantsSize(void)
{
  return constants.m_used;
}
...
static MNEUMONIC mneumonics[] = {                             //LIST
  ...
  {BINOP_FETCHCONSTANT, "FetchConstant" },                    //LIST
...
static SUBMNEUMONIC submneumonics[] = {                       //LIST
  ...
  {SUBOP_ILLEGAL,         "?????", INTERNAL_USAGE     }   // Must come last   //LIST
};                                                            //LIST
  ...
  for (k=0; k<code.here(); k++) {                             //LIST
    ...
    if (skip) {                                               //LIST
      ...
      case BINOP_CALL:                                        //LIST
        ...
        break;                                                //LIST
      case BINOP_FETCHCONSTANT:                               //LIST
        operand=dblquote                                      //LIST
                 +constants.getValue(bincode&0xffffff)        //LIST
                   +dblquote;                                 //LIST
      ...
      case BINOP_SUBOP:                                       //LIST
        for (i=0; i<m_numSysFunc; i++) {                      //LIST
          if ( subop==systemfunctions[i].binaryCode) break;   //LIST
        };                                                    //LIST
        if (i==m_numSysFunc)                                  //LIST
        {                                                     //LIST
...
{                                                                       //RDR
    ...
    {30,CTKN_NOTEQUAL,     COP_NOTEQUAL,      "!=" },                   //RDR
...
RDRCOMP::~RDRCOMP(void)                                                 //RDR
{                                                                       //RDR
  if (m_code != NULL) free(m_code);                                     //RDR
  m_code = NULL;                                                        //RDR
}                                                                       //RDR
                                                                        //RDR
...
{                                                                       //RDR
  ...
  {                                                                     //RDR
    ...
    m_code = (char *)realloc(m_code,m_codeSize);                        //RDR
  };                                                                    //RDR
...
int RDRCOMP::m_EvaluateAtomicElement(void) {                            //RDR
  ...
  { // Must be an RDR                                                   //RDR
    ...
    int status;                                                         //RDR
    int i;                                                              //RDR
    status = m_compileRDR(m_token, array);                              //RDR
    switch (status)                                                     //RDR
    {                                                                   //RDR
    case 0:                                                             //RDR
...
{                                                                       //RDR
  ...
  // 3) Perform the opeation on the top of the stack.  Go to 2)         //RDR
  //                                                                    //RDR
  ...
  return result;                                                        //RDR
                                                                        ...
                                                                        //RDR
CString RDRCOMP::CompileExpression(CString& expr,                       //RDR
                                     int (*RDR)(CString&, int *))       //RDR
{                                                                       //RDR
  int status;                                                           //RDR
  m_Initialize();                                                       //RDR
  m_expr = expr;                                                        //RDR
