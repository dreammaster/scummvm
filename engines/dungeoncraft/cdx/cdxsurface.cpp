...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static char rcsid[] = "@(#) $Id: cdxsurface.cpp,v 1.8 2002/02/25 22:48:18 cocoaspud Exp $";
#endif
...
CDXSurface::CDXSurface(CDXSurface& aSurface)					
{
    ...
    strcpy(m_FileName, aSurface.m_FileName);
...
//
//////////////////////////////////////////////////////////////////////////////////
char* CDXSurface::GetFileName(char* name)
{ 
	if(m_FileName != NULL)
...
//
//////////////////////////////////////////////////////////////////////////////////
char* CDXSurface::GetFontName(char* name)
{ 
	if(m_FontName != NULL)
		strcpy(name, m_FontName);
	else
		name = NULL;
...
HRESULT CDXSurface::ChangeFont(LOGFONT &lf)
{
  ...
  strcpy(m_FontName, lf.lfFaceName);
  return (SetFont());
}
