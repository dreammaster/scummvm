...
#ifndef DINK_DETECTION_H
#define DINK_DETECTION_H

#include "engines/advancedDetector.h"

namespace Dink {

enum DinkDebugChannels {
	kDebugGraphics = 1 << 0,
	kDebugPath     = 1 << 1,
	kDebugScan     = 1 << 2,
	kDebugFilePath = 1 << 3,
...
extern const DinkGameDescription GAME_DESCRIPTIONS[];

} // namespace Dink

class DinkMetaEngineDetection : public AdvancedMetaEngineDetection {
...
public:
	DinkMetaEngineDetection();
	~DinkMetaEngineDetection() override {}
