...
AGSOptionsWidget::AGSOptionsWidget(GuiObject *boss, const Common::String &name, const Common::String &domain) :
	...
	_traFileNames = AGS2MetaEngine::getGameTranslations(_domain);
...
GUI::OptionsContainerWidget *AGS2MetaEngine::buildEngineOptionsWidget(GUI::GuiObject *boss, const Common::String &name, const Common::String &target) const {
	return new AGS2::AGSOptionsWidget(boss, name, target);
}
