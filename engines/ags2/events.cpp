...
#include "ags2/shared/ac/keycode.h"
...
bool EventsManager::isKeyPressed(AGS2::eAGSKeyCode key, bool poll) {
	if (poll)
		pollEvents();
...
bool EventsManager::ags_key_to_scancode(AGS2::eAGSKeyCode key, Common::KeyCode(&kc)[3]) {
	...
	if (key >= AGS2::eAGSKeyCodeA && key <= AGS2::eAGSKeyCodeZ) {
		sym = static_cast<Common::KeyCode>(key - AGS2::eAGSKeyCodeA + Common::KEYCODE_a);
	}
	// Rest of the printable characters seem to match (and match ascii codes)
	else if (key >= AGS2::eAGSKeyCodeSpace && key <= AGS2::eAGSKeyCodeBackquote) {
	...
	if (sym != Common::KEYCODE_INVALID) {
		...
		switch (key) {
		case AGS2::eAGSKeyCodeAsterisk:
			kc[1] = Common::KEYCODE_KP_MULTIPLY;
			break;
		case AGS2::eAGSKeyCodePlus:
			kc[1] = Common::KEYCODE_KP_PLUS;
			break;
		case AGS2::eAGSKeyCodeHyphen:
			kc[1] = Common::KEYCODE_KP_MINUS;
			break;
		case AGS2::eAGSKeyCodeForwardSlash:
...
AGS2::eAGSKeyCode EventsManager::scummvm_key_to_ags_key(const Common::Event &event, int &ags_mod, bool old_keyhandle) {
	if (event.type != Common::EVENT_KEYDOWN)
		return AGS2::eAGSKeyCodeNone;
	...
	ags_mod = 0;
	if (mod & Common::KBD_SHIFT) ags_mod |= AGS2::eAGSModLShift;
	if (mod & Common::KBD_CTRL)  ags_mod |= AGS2::eAGSModLCtrl;
	if (mod & Common::KBD_ALT)   ags_mod |= AGS2::eAGSModLAlt;
	if (mod & Common::KBD_NUM)   ags_mod |= AGS2::eAGSModNum;
	if (mod & Common::KBD_CAPS)  ags_mod |= AGS2::eAGSModCaps;
	...
	if (old_keyhandle && (sym >= Common::KEYCODE_a && sym <= Common::KEYCODE_z)) {
		if ((mod & Common::KBD_CTRL) != 0) // align letters to code 1
			return static_cast<AGS2::eAGSKeyCode>(0 + (sym - Common::KEYCODE_a) + 1);
		else if ((mod & Common::KBD_ALT) != 0) // align letters to code 301
			return static_cast<AGS2::eAGSKeyCode>(AGS_EXT_KEY_SHIFT + (sym - Common::KEYCODE_a) + 1);
	}
	// New mode: also handle common key range
	else if (!old_keyhandle && (sym >= Common::KEYCODE_SPACE && sym <= Common::KEYCODE_z)) {
		return static_cast<AGS2::eAGSKeyCode>(sym);
	}

	if (event.kbd.ascii >= 32 && event.kbd.ascii <= 127)
		return static_cast<AGS2::eAGSKeyCode>(event.kbd.ascii);
	...
	if ((sym >= Common::KEYCODE_KP1 && sym <= Common::KEYCODE_KP_PERIOD) && (mod & Common::KBD_NUM) != 0) {
		...
		case Common::KEYCODE_KP9:
			return static_cast<AGS2::eAGSKeyCode>(sym - Common::KEYCODE_KP1 + Common::KEYCODE_1);
		case Common::KEYCODE_KP0:
			return AGS2::eAGSKeyCode0;
		case Common::KEYCODE_KP_PERIOD:
			return AGS2::eAGSKeyCodePeriod;
		default:
			return AGS2::eAGSKeyCodeNone;
		}
	}
	...
	case Common::KEYCODE_BACKSPACE:
		return AGS2::eAGSKeyCodeBackspace;
	case Common::KEYCODE_TAB:
		return AGS2::eAGSKeyCodeTab;
	case Common::KEYCODE_RETURN:
	case Common::KEYCODE_KP_ENTER:
		return AGS2::eAGSKeyCodeReturn;
	case Common::KEYCODE_ESCAPE:
		return AGS2::eAGSKeyCodeEscape;

	case Common::KEYCODE_F1:
		return AGS2::eAGSKeyCodeF1;
	case Common::KEYCODE_F2:
		return AGS2::eAGSKeyCodeF2;
	case Common::KEYCODE_F3:
		return AGS2::eAGSKeyCodeF3;
	case Common::KEYCODE_F4:
		return AGS2::eAGSKeyCodeF4;
	case Common::KEYCODE_F5:
		return AGS2::eAGSKeyCodeF5;
	case Common::KEYCODE_F6:
		return AGS2::eAGSKeyCodeF6;
	case Common::KEYCODE_F7:
		return AGS2::eAGSKeyCodeF7;
	case Common::KEYCODE_F8:
		return AGS2::eAGSKeyCodeF8;
	case Common::KEYCODE_F9:
		return AGS2::eAGSKeyCodeF9;
	case Common::KEYCODE_F10:
		return AGS2::eAGSKeyCodeF10;
	case Common::KEYCODE_F11:
		return AGS2::eAGSKeyCodeF11;
	case Common::KEYCODE_F12:
		return AGS2::eAGSKeyCodeF12;

	case Common::KEYCODE_KP7:
	case Common::KEYCODE_HOME:
		return AGS2::eAGSKeyCodeHome;
	case Common::KEYCODE_KP8:
	case Common::KEYCODE_UP:
		return AGS2::eAGSKeyCodeUpArrow;
	case Common::KEYCODE_KP9:
	case Common::KEYCODE_PAGEUP:
		return AGS2::eAGSKeyCodePageUp;
	case Common::KEYCODE_KP4:
	case Common::KEYCODE_LEFT:
		return AGS2::eAGSKeyCodeLeftArrow;
	case Common::KEYCODE_KP5:
		return AGS2::eAGSKeyCodeNumPad5;
	case Common::KEYCODE_KP6:
	case Common::KEYCODE_RIGHT:
		return AGS2::eAGSKeyCodeRightArrow;
	case Common::KEYCODE_KP1:
	case Common::KEYCODE_END:
		return AGS2::eAGSKeyCodeEnd;
	case Common::KEYCODE_KP2:
	case Common::KEYCODE_DOWN:
		return AGS2::eAGSKeyCodeDownArrow;
	case Common::KEYCODE_KP3:
	case Common::KEYCODE_PAGEDOWN:
		return AGS2::eAGSKeyCodePageDown;
	case Common::KEYCODE_KP0:
	case Common::KEYCODE_INSERT:
		return AGS2::eAGSKeyCodeInsert;
	case Common::KEYCODE_KP_PERIOD:
	case Common::KEYCODE_DELETE:
		return AGS2::eAGSKeyCodeDelete;

	// KeyPad (remaining keys, not handled above)
	case Common::KEYCODE_KP_DIVIDE:
		return AGS2::eAGSKeyCodeForwardSlash;
	case Common::KEYCODE_KP_MULTIPLY:
		return AGS2::eAGSKeyCodeAsterisk;
	case Common::KEYCODE_KP_MINUS:
		return AGS2::eAGSKeyCodeHyphen;
	case Common::KEYCODE_KP_PLUS:
		return AGS2::eAGSKeyCodePlus;

	case Common::KEYCODE_LSHIFT:
		return AGS2::eAGSKeyCodeLShift;
	case Common::KEYCODE_RSHIFT:
		return AGS2::eAGSKeyCodeRShift;
	case Common::KEYCODE_LCTRL:
		return AGS2::eAGSKeyCodeLCtrl;
	case Common::KEYCODE_RCTRL:
		return AGS2::eAGSKeyCodeRCtrl;
	case Common::KEYCODE_LALT:
		return AGS2::eAGSKeyCodeLAlt;
	case Common::KEYCODE_RALT:
		return AGS2::eAGSKeyCodeRAlt;
