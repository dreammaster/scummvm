...
#include "ags2/shared/util/bbop.h"
#include "ags2/shared/util/file.h"
#include "ags2/shared/util/stream.h"
#include "ags2/shared/util/text_stream_writer.h"
#include "ags2/engine/ac/dynobj/script_string.h"
#include "ags2/engine/ac/dynobj/script_user_object.h"
#include "ags2/engine/ac/sys_events.h"
#include "ags2/shared/util/memory.h"
#include "ags2/shared/util/string_utils.h" // linux strnicmp definition
...
int ccInstance::Run(int32_t curpc) {
	...
	const bool dump_opcodes = (ccGetOption(SCOPT_DEBUGRUN) != 0) ||
							  (gDebugLevel > 0 && DebugMan.isDebugChannelEnabled(::AGS2::kDebugScript));
#endif
