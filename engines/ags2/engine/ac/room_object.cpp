...
#include "ags2/shared/ac/common_defines.h"
...
int RoomObject::GetFrameSoundVolume() const {
	...
	return AGS2::CalcFrameSoundVolume(anim_volume, cur_anim_volume);
}

void RoomObject::CheckViewFrame() {
	AGS2::CheckViewFrame(view, loop, frame, GetFrameSoundVolume());
}
