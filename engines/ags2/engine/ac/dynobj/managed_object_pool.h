...
#ifndef AGS2_ENGINE_AC_DYNOBJ_CC_MANAGED_OBJECT_POOL_H
#define AGS2_ENGINE_AC_DYNOBJ_CC_MANAGED_OBJECT_POOL_H
...
#include "ags2/engine/ac/dynobj/cc_script_object.h"   // IScriptObject
