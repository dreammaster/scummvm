...
#include "ags2/shared/ac/view.h"
#include "ags2/engine/ac/audio_channel.h"
#include "ags2/engine/ac/button.h"
#include "ags2/engine/ac/character.h"
#include "ags2/engine/ac/dialog.h"
...
#include "ags2/engine/ac/gui.h"
#include "ags2/engine/ac/hotspot.h"
...
#include "ags2/engine/ac/overlay.h"
#include "ags2/engine/ac/path_helper.h"
#include "ags2/engine/ac/sys_events.h"
...
#include "ags2/engine/ac/translation.h"
#include "ags2/engine/ac/dynobj/all_dynamic_classes.h"
#include "ags2/engine/ac/dynobj/all_script_classes.h"
#include "ags2/engine/ac/dynobj/script_camera.h"
#include "ags2/engine/ac/dynobj/script_game.h"
#include "ags2/engine/ac/dynobj/dynobj_manager.h"
#include "ags2/engine/debugging/debug_log.h"
...
#include "ags2/engine/script/script_runtime.h"
#include "ags2/shared/util/directory.h"
#include "ags2/shared/util/file.h"
#include "ags2/shared/util/path.h"

#include "ags2/shared/debugging/out.h"
#include "ags2/engine/script/script_api.h"
#include "ags2/engine/script/script_runtime.h"
#include "ags2/ags2.h"
...
String get_save_game_path(int slotNum) {
	...
	return Common::String::format("%s%s", SAVE_FOLDER_PREFIX,
		::AGS2::g_vm->getSaveStateName(slotNum).c_str());
#else
