...
#ifndef AGS2_ENGINE_MAIN_GRAPHICS_MODE_H
#define AGS2_ENGINE_MAIN_GRAPHICS_MODE_H

#include "ags2/engine/gfx/gfx_defines.h"
#include "ags2/shared/util/geometry.h"
#include "ags2/shared/util/scaling.h"
...
struct WindowSetup
{
    AGS2::Size           Size;      // explicit screen metrics
    int                  Scale = 0; // explicit game scale factor
    WindowMode           Mode = AGS::Engine::kWnd_Windowed; // window mode

    WindowSetup() = default;
    WindowSetup(const AGS2::Size &sz, WindowMode mode = AGS::Engine::kWnd_Windowed)
