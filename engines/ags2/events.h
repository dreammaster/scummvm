...
#ifndef AGS2_EVENTS_H
#define AGS2_EVENTS_H
...
public:
	 ...
	 */
	static bool ags_key_to_scancode(AGS2::eAGSKeyCode key, Common::KeyCode(&kc)[3]);

	/*
	 * Converts a ScummVM event to the ags keycode
	 */
	static AGS2::eAGSKeyCode scummvm_key_to_ags_key(const Common::Event &event, int &ags_mod, bool old_keyhandle);
...
public:
	 ...
	 */
	bool isKeyPressed(AGS2::eAGSKeyCode key, bool poll = true);
