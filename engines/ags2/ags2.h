...
public:
	...
	Music *_music;
	::AGS2::GFX_DRIVER *_gfxDriver;
	::AGS2::Globals *_globals;
	bool _forceTextAA;
protected:
	// Engine APIs
	Common::Error run() override;
public:
	AGSEngine(OSystem *syst, const AGS2GameDescription *gameDesc);
	~AGSEngine() override;
...
#define gfx_driver ::AGS2::g_vm->_gfxDriver
#define SHOULD_QUIT ::AGS2::g_vm->shouldQuit()
