...
#ifndef AGS2_SHARED_AC_OLD_GAME_SETUP_STRUCT_H
#define AGS2_SHARED_AC_OLD_GAME_SETUP_STRUCT_H

#if defined (OBSOLETE)

#include "ags2/shared/ac/character_info.h"       // OldCharacterInfo, CharacterInfo
#include "ags2/shared/ac/event_block.h"       // EventBlock
#include "ags2/shared/ac/interface_element.h"    // InterfaceElement
#include "ags2/shared/ac/inventory_item_info.h"   // InventoryItemInfo
#include "ags2/shared/ac/mouse_cursor.h"      // MouseCursor
#include "ags2/shared/ac/words_dictionary.h"  // WordsDictionary
#include "ags2/shared/script/cc_script.h"           // ccScript
