...
#ifndef AGS2_SHARED_AC_GAME_SETUP_STRUCT_BASE_H
#define AGS2_SHARED_AC_GAME_SETUP_STRUCT_BASE_H

#include "ags2/lib/allegro.h" // RGB
...
struct GameSetupStructBase {
	...
	inline bool IsLegacyHiRes() const {
		...
		return ::AGS2::IsLegacyHiRes(_resolutionType);
	}
