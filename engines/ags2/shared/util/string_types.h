...
#ifndef AGS2_SHARED_UTIL_STRING_TYPES_H
#define AGS2_SHARED_UTIL_STRING_TYPES_H
...
struct CaseSensitiveString_EqualTo {
	bool operator()(const ::AGS2::AGS::Shared::String &x, const ::AGS2::AGS::Shared::String &y) const {
		return x.Compare(y) == 0;
	}
};

struct CaseSensitiveString_Hash {
	uint operator()(const ::AGS2::AGS::Shared::String &x) const {
...
// hash anyway.
template<>
struct Hash<AGS2::AGS::Shared::String> {
	uint operator()(const AGS2::AGS::Shared::String &s) const {
