...
#ifndef AGS2_DETECTION_H
#define AGS2_DETECTION_H
...
extern const AGS2GameDescription GAME_DESCRIPTIONS[];
...
public:
	AGS2MetaEngineDetection();
	~AGS2MetaEngineDetection() override {}
	...
	const char *getEngineName() const override {
		return "Adventure Game Studio - Early";
	}
