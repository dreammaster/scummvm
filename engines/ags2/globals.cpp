...
#include "ags2/shared/ac/game_setup_struct.h"
#include "ags2/shared/ac/sprite_cache.h"
#include "ags2/shared/ac/dialog_topic.h"
#include "ags2/shared/core/asset_manager.h"
#include "ags2/shared/debugging/debug_manager.h"
#include "ags2/shared/font/fonts.h"
#include "ags2/shared/font/ttf_font_renderer.h"
#include "ags2/shared/font/wfn_font_renderer.h"
#include "ags2/shared/game/interactions.h"
#include "ags2/shared/game/room_struct.h"
#include "ags2/shared/game/tra_file.h"
#include "ags2/shared/gui/gui_button.h"
#include "ags2/shared/gui/gui_inv.h"
#include "ags2/shared/gui/gui_label.h"
#include "ags2/shared/gui/gui_listbox.h"
#include "ags2/shared/gui/gui_slider.h"
#include "ags2/shared/gui/gui_textbox.h"
#include "ags2/shared/script/cc_common.h"
#include "ags2/shared/util/directory.h"
#include "ags2/engine/ac/character_extras.h"
#include "ags2/engine/ac/draw.h"
#include "ags2/engine/ac/draw_software.h"
#include "ags2/engine/ac/event.h"
#include "ags2/engine/ac/game_setup.h"
#include "ags2/engine/ac/game_state.h"
#include "ags2/engine/ac/lip_sync.h"
#include "ags2/engine/ac/mouse.h"
#include "ags2/engine/ac/move_list.h"
#include "ags2/engine/ac/room_status.h"
#include "ags2/engine/ac/route_finder_jps.h"
#include "ags2/engine/ac/screen_overlay.h"
#include "ags2/engine/ac/sprite.h"
#include "ags2/engine/ac/sprite_list_entry.h"
#include "ags2/engine/ac/top_bar_settings.h"
#include "ags2/engine/ac/dynobj/cc_audio_channel.h"
#include "ags2/engine/ac/dynobj/cc_audio_clip.h"
#include "ags2/engine/ac/dynobj/cc_character.h"
#include "ags2/engine/ac/dynobj/cc_dialog.h"
#include "ags2/engine/ac/dynobj/cc_dynamic_array.h"
#include "ags2/engine/ac/dynobj/cc_gui.h"
#include "ags2/engine/ac/dynobj/cc_gui_object.h"
#include "ags2/engine/ac/dynobj/cc_hotspot.h"
#include "ags2/engine/ac/dynobj/cc_inventory.h"
#include "ags2/engine/ac/dynobj/cc_object.h"
#include "ags2/engine/ac/dynobj/cc_region.h"
#include "ags2/engine/ac/dynobj/cc_serializer.h"
#include "ags2/engine/ac/dynobj/cc_static_array.h"
#include "ags2/engine/ac/dynobj/managed_object_pool.h"
#include "ags2/engine/ac/dynobj/script_audio_channel.h"
#include "ags2/engine/ac/dynobj/script_dialog.h"
#include "ags2/engine/ac/dynobj/script_dialog_options_rendering.h"
#include "ags2/engine/ac/dynobj/script_game.h"
#include "ags2/engine/ac/dynobj/script_gui.h"
#include "ags2/engine/ac/dynobj/script_hotspot.h"
#include "ags2/engine/ac/dynobj/script_inv_item.h"
#include "ags2/engine/ac/dynobj/script_object.h"
#include "ags2/engine/ac/dynobj/script_region.h"
#include "ags2/engine/ac/dynobj/script_string.h"
#include "ags2/engine/ac/dynobj/script_system.h"
#include "ags2/engine/debugging/debugger.h"
#include "ags2/engine/debugging/log_file.h"
#include "ags2/engine/debugging/message_buffer.h"
#include "ags2/engine/device/mouse_w32.h"
#include "ags2/engine/gfx/gfxfilter.h"
#include "ags2/engine/gui/animating_gui_button.h"
#include "ags2/engine/gui/csci_dialog.h"
#include "ags2/engine/gui/gui_dialog_defines.h"
#include "ags2/engine/gui/new_control.h"
#include "ags2/engine/main/graphics_mode.h"
#include "ags2/engine/media/audio/ambient_sound.h"
#include "ags2/engine/media/audio/audio_defines.h"
#include "ags2/engine/platform/base/ags_platform_driver.h"
#include "ags2/engine/script/cc_instance.h"
#include "ags2/engine/script/executing_script.h"
#include "ags2/engine/script/non_blocking_script_function.h"
#include "ags2/engine/script/script.h"
#include "ags2/engine/script/system_imports.h"
#include "common/std/limits.h"
#include "ags2/plugins/ags_plugin.h"
#include "ags2/plugins/plugin_engine.h"
#include "ags2/plugins/core/core.h"
