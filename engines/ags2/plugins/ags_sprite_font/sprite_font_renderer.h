...
#ifndef AGS2_PLUGINS_AGS_SPRITE_FONT_SPR_FONT_RENDERER_H
#define AGS2_PLUGINS_AGS_SPRITE_FONT_SPR_FONT_RENDERER_H

#include "ags2/plugins/ags_sprite_font/sprite_font.h"
