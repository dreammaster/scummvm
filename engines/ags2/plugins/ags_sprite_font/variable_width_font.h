...
#ifndef AGS2_PLUGINS_AGS_SPRITE_FONT_VAR_WIDTH_FONT_H
#define AGS2_PLUGINS_AGS_SPRITE_FONT_VAR_WIDTH_FONT_H

#include "ags2/plugins/ags_sprite_font/character_entry.h"
