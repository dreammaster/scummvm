...
#include "ags2/plugins/plugin_base.h"
#include "ags2/plugins/ags_agi/ags_agi.h"
#include "ags2/plugins/ags_app_open_url/ags_app_open_url.h"
#include "ags2/plugins/ags_blend/ags_blend.h"
#include "ags2/plugins/ags_bm_font_renderer/ags_bm_font_renderer.h"
#include "ags2/plugins/ags_clipboard/ags_clipboard.h"
#include "ags2/plugins/ags_collision_detector/ags_collision_detector.h"
#include "ags2/plugins/ags_consoles/ags_consoles.h"
#include "ags2/plugins/ags_controller/ags_controller.h"
#include "ags2/plugins/ags_controller/ags_controller_arcnor.h"
#include "ags2/plugins/ags_creditz/ags_creditz1.h"
#include "ags2/plugins/ags_creditz/ags_creditz2.h"
#include "ags2/plugins/ags_filedel/ags_filedel.h"
#include "ags2/plugins/ags_fire/ags_fire.h"
#include "ags2/plugins/ags_flashlight/ags_flashlight.h"
#include "ags2/plugins/ags_galaxy_steam/ags_wadjeteye_steam.h"
#include "ags2/plugins/ags_galaxy_steam/ags_galaxy_steam.h"
#include "ags2/plugins/ags_joy/ags_joy.h"
#include "ags2/plugins/ags_maya/ags_maya.h"
#include "ags2/plugins/ags_nickenstien_gfx/ags_nickenstien_gfx.h"
#include "ags2/plugins/ags_pal_render/ags_pal_render.h"
#include "ags2/plugins/ags_parallax/ags_parallax.h"
#include "ags2/plugins/ags_shell/ags_shell.h"
#include "ags2/plugins/ags_snow_rain/ags_snow_rain.h"
#include "ags2/plugins/ags_sock/ags_sock.h"
#include "ags2/plugins/ags_sprite_font/ags_sprite_font.h"
#include "ags2/plugins/ags_sprite_font/ags_sprite_font_clifftop.h"
#include "ags2/plugins/ags_sprite_video/ags_sprite_video.h"
#include "ags2/plugins/ags_tcp_ip/ags_tcp_ip.h"
#include "ags2/plugins/ags_touch/ags_touch.h"
#include "ags2/plugins/ags_trans/ags_trans.h"
#include "ags2/plugins/ags_utils/ags_utils.h"
#include "ags2/plugins/ags_wadjet_util/ags_wadjet_util.h"
#include "ags2/plugins/ags_waves/ags_waves.h"
#include "ags2/ags2.h"
...
Plugins::PluginBase *pluginOpen(const char *filename) {
	...
	int version = 0;
	for (const ::AGS2::PluginVersion *v = ::AGS2::g_vm->getNeededPlugins();
	        v && v->_plugin; ++v) {
	...
	if (fname.equalsIgnoreCase("AGSSpriteFont") || fname.equalsIgnoreCase("agsplugin.spritefont")) {
		if (version == ::AGS2::kClifftopGames)
	...
	if (fname.equalsIgnoreCase("agsteam") && version == ::AGS2::kWadjetEye)
