...
#include "ags2/plugins/core/drawing_surface.h"
#include "ags2/shared/ac/game_struct_defines.h"
#include "ags2/engine/ac/drawing_surface.h"
...
void DrawingSurface::DrawImage(ScriptMethodParams &params) {
	...
	AGS2::DrawingSurface_DrawImage6(sds, xx, yy, slot, trans, width, height);
}
...
void DrawingSurface::DrawLine(ScriptMethodParams &params) {
	...
	AGS2::DrawingSurface_DrawLine(sds, fromx, fromy, tox, toy, thickness);
}
...
void DrawingSurface::ScPl_DrawString(ScriptMethodParams &params) {
	...
	AGS2::DrawingSurface_DrawString(sds, xx, yy, font, buf.c_str());
}
...
void DrawingSurface::DrawStringWrapped_Old(ScriptMethodParams &params) {
	...
	AGS2::DrawingSurface_DrawStringWrapped_Old(sds, xx, yy, wid, font, alignment, msg);
}

void DrawingSurface::DrawStringWrapped(ScriptMethodParams &params) {
	PARAMS7(ScriptDrawingSurface *, sds, int, xx, int, yy, int, wid, int, font, int, alignment, const char *, msg);
	AGS2::DrawingSurface_DrawStringWrapped(sds, xx, yy, wid, font, alignment, msg);
}
...
void DrawingSurface::DrawSurface(ScriptMethodParams &params) {
	...
	AGS2::DrawingSurface_DrawSurface2(target, source, translev);
}
