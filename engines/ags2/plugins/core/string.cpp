...
void String::Replace(ScriptMethodParams &params) {
	...
	params._result = AGS2::String_Replace(thisString, lookForText, replaceWithText, caseSensitive);
}

void String::ReplaceCharAt(ScriptMethodParams &params) {
	PARAMS3(const char *, thisString, int, index, char, newChar);
	params._result = AGS2::String_ReplaceCharAt(thisString, index, newChar);
}
