...
void Room::GetDrawingSurfaceForBackground(ScriptMethodParams &params) {
	...
	params._result = AGS2::Room_GetDrawingSurfaceForBackground(backgroundNumber);
}
