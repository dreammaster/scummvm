...
void Overlay::CreateGraphical(ScriptMethodParams &params) {
	...
	params._result = AGS2::Overlay_CreateGraphical(x, y, slot, transparent);
}
...
void Overlay::ScPl_CreateTextual(ScriptMethodParams &params) {
	...
	params._result = AGS2::Overlay_CreateTextual(x, y, width, font, colour, text);
}
