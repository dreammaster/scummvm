...
#include "ags2/engine/gfx/gfx_util.h"
#include "ags2/engine/gfx/gfxfilter.h"
#include "ags2/shared/gui/gui_defines.h"
...
#include "ags2/engine/script/runtime_script_value.h"
#include "ags2/engine/script/script.h"
#include "ags2/engine/script/script_runtime.h"
#include "ags2/shared/util/file_stream.h"
#include "ags2/engine/util/library.h"
#include "ags2/engine/util/library_scummvm.h"
#include "ags2/shared/util/memory.h"
#include "ags2/shared/util/stream.h"
#include "ags2/shared/util/string_compat.h"
#include "ags2/shared/util/wgt2_allg.h"
...
void IAGSEngine::SimulateMouseClick(int32 button) {
	AGS2::SimulateMouseClick(button);
}
