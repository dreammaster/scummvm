...
static const KeybindingRecord GAMEPLAY_KEYS[] = {
	...
	{ KEYBIND_ATTACK_UP, "ATTACK_UP", _s("Attack Up"), "8", nullptr},
	{ KEYBIND_ATTACK_DOWN, "ATTACK_DOWN", _s("Attack Down"), "2", nullptr},
	{ KEYBIND_ATTACK_LEFT, "ATTACK_LEFT", _s("Attack Left"), "4", nullptr},
	{ KEYBIND_ATTACK_RIGHT, "ATTACK_RIGHT", _s("Attack Right"), "6", nullptr},
...
// Space has everything but the directional attack keys (though most don't do anything).
// Not those keys because the numbers are used for speed control
static const KeybindingRecord SPACE_KEYS[] = {
	{ KEYBIND_UP, "UP", _s("Up"), "UP", "JOY_UP"},
	{ KEYBIND_DOWN, "DOWN", _s("Down"), "DOWN", "JOY_DOWN"},
	{ KEYBIND_LEFT, "LEFT", _s("Left"), "LEFT", "JOY_LEFT"},
	{ KEYBIND_RIGHT, "RIGHT", _s("Right"), "RIGHT", "JOY_RIGHT"},
...
static const KeysRecord SPACE_RECORDS[] = {
	{ "Ultima1", _s("Basic keys"), MINIMAL_KEYS },
	{ "space", _s("Gameplay keys"), SPACE_KEYS },
	{ nullptr, nullptr, nullptr }
};
