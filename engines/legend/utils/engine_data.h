 ...
 * zip file for the legend engine, by mapping it into ScummVM's filesystem.
 ...
 *
 * The legend engine has an associated data zip file whose contents are
 * in /devtools/create_legend/files/. Each game has their own subfolder
 * within it, and as part of the release process, this folder will be
 * zipped up as a file 'legend.dat', and included with ScummVM releases.
 *
 * For development purposes, if you go the Game Options dialog for a
 * game in the ScummVM launcher, and set the extra path to
 * /devtools/create_legend, the engine will access the files directly
 * without requiring you to keep regenerating legend.dat.
 *
 */

#ifndef LEGEND_UTILS_ENGINE_DATA_H
#define LEGEND_UTILS_ENGINE_DATA_H
 ...
 * @param isEarlyGame	If true, contents of early/ folder are included.
 *                      If false, contents of later/ folder are included. 
 ...
 */
extern bool load_engine_data(const Common::String &subfolder, bool isEarlyGame,
