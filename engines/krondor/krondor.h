...
struct KrondorGameDescription;

class KrondorEngine : public Engine, public Events {
private:
...
public:
	KrondorEngine(OSystem *syst, const ADGameDescription *gameDesc);
	~KrondorEngine() override;
...
#define SHOULD_QUIT ::Krondor::g_engine->shouldQuit()
